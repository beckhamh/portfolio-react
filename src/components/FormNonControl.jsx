...
export default function FormNonControl() {
    ...
    return <>
        ...
        <form className={styles.form} ref={form} onSubmit={handleSubmit} noValidate>
            ...
            <input type="text" name='user_name' placeholder='Nom' required maxLength={35} ref={nameRef} onSubmit={validateName} />
            {mssgErrName !== '' &&
            ...
            <input type="text" name='subject' placeholder='Objet' required ref={subjectRef} onSubmit={validateSubj} />
            {mssgErrSubj !== '' &&
            ...
            <div className={styles.infos}>
                ...
                <p className={styles.p2}>belkacem.heraoua@hotmail.com</p>
            </div>
            <div className={styles.infos}>
                <IconContext.Provider value={{ size: '20px', color: '#1481BA' }}>
                    <MdPlace />
                </IconContext.Provider>
                <p className={styles.p2}>Montreal, Quebec, Canada</p>
            </div>
